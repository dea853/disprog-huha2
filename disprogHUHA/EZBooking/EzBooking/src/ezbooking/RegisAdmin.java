...
public class RegisAdmin extends javax.swing.JFrame {
    ...
    public String registrasiAdmin(String username, String password) {
        service = new com.ubaya.disprog.EzBookingWS_Service();
        port = service.getEzBookingWSPort();
        return port.registrasiAdmin(username, password);
    }
    
    private void btnRegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisActionPerformed
        // TODO add your handling code here:
        String retReg = this.registrasiAdmin(txtUsername.getText(), txtPassword.getText());
